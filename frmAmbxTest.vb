...
Public Class frmAmbxTest
    ...
    Private Sub frmAmbxTest_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            '---- connect to amBX
            amBX.Connect(1, 0, "amBXTest", "1.0.0")

            '---- good to go, should be able to use the IamBX object now
            '     create some objects
            LeftLight = amBX.Lights.Add("Left", amBXLibrary.Locations.East, amBXLibrary.Heights.AnyHeight)
            RightLight = New amBX.Light(amBXLibrary.Locations.West, amBXLibrary.Heights.AnyHeight)
